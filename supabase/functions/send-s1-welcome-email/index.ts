// send-s1-welcome-email v19 (2026-09-21): email_sends send-once + stable Idempotency-Key (no Date.now()).
...
// - v19: claim public.email_sends(user_id, email_id=s1_1_welcome) before Resend; release on failure;
