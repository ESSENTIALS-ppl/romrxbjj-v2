...
const BRANDS: Record<string, Brand> = {
  ...
  general: {
    ...
    durationLine: "It takes about 15 minutes on your phone. You'll see your top three problem areas and a clear next step for longevity, self-care, and mobility.",
